  ...
  return (
    <div className="screen-content">
      ...
      {loggedInUser && recordedBenefitAccounting && <>
        <p className="muted small-note">These are simulated benefits you recorded in three ways: for yourself, for your dependents, and on behalf of other people. On-behalf amounts are attributed to those people, not to you — not everyone else’s prototype totals.</p>
        <div className="card-grid three claim-summary-grid"><Metric label="Yourself" value={formatMoney(recordedBenefitAccounting.yourself.totalAmount)} note={`Benefits you recorded for yourself · ${recordedBenefitNote(recordedBenefitAccounting.yourself)}`} /><Metric label="Dependents" value={formatMoney(recordedBenefitAccounting.dependents.totalAmount)} note={`Benefits you recorded for your dependents · ${recordedBenefitNote(recordedBenefitAccounting.dependents)}`} /><Metric label="On behalf of others" value={formatMoney(recordedBenefitAccounting.onBehalfOfOthers.totalAmount)} note={`Attributed to those people, not to you · ${recordedBenefitNote(recordedBenefitAccounting.onBehalfOfOthers)}`} /></div>
      </>}
